...
const ProblemSection = () => {
  ...
  const problems = [
    { num: "01", title: { en: "Overcrowded Feeds", th: "Feeds ที่แออัด" }, desc: { en: "Attention is now the scarcest resource. Brands without a clear point of view disappear.", th: "Attention คือทรัพยากรที่หายากที่สุด แบรนด์ที่ไม่มีจุดยืนชัดเจนจะหายไป" } },
    { num: "02", title: { en: "Lost Meaning", th: "ความหมายที่หายไป" }, desc: { en: "Brands say too much and communicate nothing. Clarity is the new competitive advantage.", th: "แบรนด์พูดมากเกินไปแต่ไม่ได้สื่ออะไร ความชัดเจนคือข้อได้เปรียบใหม่" } },
    { num: "03", title: { en: "Template Culture", th: "วัฒนธรรม Template" }, desc: { en: "AI-generated filler floods every platform. Real strategy is the only thing that differentiates.", th: "Content จาก AI ท่วมทุก platform กลยุทธ์จริงเท่านั้นที่สร้างความแตกต่าง" } },
    { num: "04", title: { en: "Short-term Thinking", th: "คิดแค่ระยะสั้น" }, desc: { en: "Chasing virality erodes brand equity. Growth that lasts is built, not hacked.", th: "การไล่ตาม viral ทำลายมูลค่าแบรนด์ การเติบโตที่ยั่งยืนต้องสร้าง ไม่ใช่ hack" } },
    { num: "05", title: { en: "Fragmented Vendors", th: "Vendor กระจัดกระจาย" }, desc: { en: "Three agencies, five tools, zero consistency. Your brand voice fractures with every handoff.", th: "สามเอเจนซี่ ห้าเครื่องมือ ไม่มีความ consistent — Brand voice แตกสลายทุกครั้งที่ส่งต่อ" } },
    { num: "06", title: { en: "Speed vs Quality", th: "ความเร็ว vs คุณภาพ" }, desc: { en: "Traditional agencies are slow. Pure AI is shallow. You deserve both — and that's what we built.", th: "เอเจนซี่ทั่วไปช้า AI ล้วนๆ ตื้นเกินไป คุณสมควรได้ทั้งคู่ — นั่นคือสิ่งที่เราสร้าง" } },
  ];
