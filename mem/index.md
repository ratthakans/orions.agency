...
**6/3/1 (60/30/10) is the governing ratio** — content, color (60 snow / 30 ink / 10 cinnabar — never exceed), typography, 10-col layouts.
Brand 'ØRIONS'. Fonts: **Inter** (display H1–H3 Bold, body, UI, brand wordmark tracked +0.16em uppercase), **Newsreader** (serif italic ACCENT WORDS only, inside headings via `<em className="italic text-cinnabar">…</em>`), **IBM Plex Mono** (eyebrows / page chrome / meta), IBM Plex Sans Thai (Thai fallback).
