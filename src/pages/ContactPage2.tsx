...
const ContactPage = () => {
  return (
    <main className="bg-background min-h-screen">
      ...
      {/* Contact info */}
      <section className="py-16 md:py-28 px-6 md:px-12 border-t border-border/40">
        <div className="max-w-[680px] mx-auto">
          <div className="space-y-6">
            <motion.div {...fadeIn(0.05)}>
              ...
              <a
                ...
                className="font-body text-[18px] md:text-[20px] text-foreground hover:text-accent transition-colors duration-300"
              >
                hello@orions.agency
              </a>
            </motion.div>
            ...
            <motion.div {...fadeIn(0.1)}>
              ...
              <a href="tel:+66923905464" className="font-body text-[18px] md:text-[20px] text-foreground/80">
                092 390 5464
              </a>
            </motion.div>
            ...
            <motion.div {...fadeIn(0.15)}>
              ...
              <a
                ...
                className="font-body text-[18px] md:text-[20px] text-foreground/80 hover:text-foreground transition-colors duration-300"
              >
                orions.agency
              </a>
            </motion.div>
          ...
          <motion.div {...fadeIn(0.2)} className="mt-12 pt-10 border-t border-border/40">
