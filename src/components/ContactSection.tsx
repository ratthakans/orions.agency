        ...
        <AnimatedSection delay={0.05}>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-divider border border-divider mb-20">
            <div className="bg-background p-6 md:p-8 group hover:bg-secondary transition-colors duration-300">
              ...
              <a href="mailto:hello@orions.agency" className="font-body text-foreground group-hover:text-accent-warm transition-colors duration-300">
                hello@orions.agency →
              </a>
            </div>
            <div className="bg-background p-6 md:p-8 group hover:bg-secondary transition-colors duration-300">
              <p className="font-display text-xs tracking-[0.2em] uppercase text-muted-foreground mb-2">Phone</p>
              <a href="tel:+66923905464" className="font-body text-foreground group-hover:text-accent-warm transition-colors duration-300">
                +66 92 390 5464 →
              </a>
            </div>
            <div className="bg-background p-6 md:p-8 group hover:bg-secondary transition-colors duration-300">
