  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50">
      ...
      <div className="bg-background/95 backdrop-blur-sm border-b border-foreground/10 px-6 md:px-10 h-[64px] flex items-center justify-between">
        ...
        <Link
          to="/contact"
          className="group hidden md:inline-flex items-center gap-2 btn-label bg-background text-foreground px-4 py-2.5 border border-foreground transition-all duration-300 hover:gap-3 hover:bg-background hover:text-foreground"
        >
