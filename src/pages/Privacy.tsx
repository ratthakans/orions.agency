...
const sections = [
  {
    n: "01",
    h: "ข้อมูลที่เราเก็บ",
    body: "เฉพาะที่คุณกรอกเอง — ชื่อ เบอร์ติดต่อ อีเมล ชื่อบริษัท แพ็กเกจที่สนใจ และข้อความ จากฟอร์มติดต่อ · สถิติการใช้งานเว็บเก็บแบบไม่ระบุตัวตนผ่าน Plausible (ไม่มีคุกกี้ ไม่ติดตามข้ามเว็บ).",
  },
  {
    n: "02",
    h: "ใช้ทำอะไร",
    body: "ติดต่อกลับเรื่องที่คุณสอบถาม · ปรับปรุงเนื้อหาและบริการของเรา · เราไม่ขาย ไม่แลกเปลี่ยน และไม่ส่งต่อข้อมูลของคุณให้บุคคลที่สามเพื่อการตลาด.",
  },
  {
    n: "03",
    h: "เก็บนานแค่ไหน",
      ...
      <div className="max-w-[1280px] mx-auto">
        ...
        <Reveal delay={0.1}>
          <h1 lang="th" className="mt-8 h-display-lg max-w-[16ch] thai-wrap">
            เก็บเท่าที่จำเป็น — <em className="text-foreground">พูดตรง.</em>
          </h1>
        </Reveal>
        <Reveal delay={0.2}>
