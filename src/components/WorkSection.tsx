    ...
    <section id="work" className="py-24 md:py-32 px-6 md:px-12">
      <div className="max-w-7xl mx-auto">
        ...
        <AnimatedSection>
          ...
          <p className="font-body text-[15px] leading-[1.8] text-muted-foreground max-w-lg mb-16">
            {t(
        ...
        {/* Featured — first 2 projects side by side */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-divider border border-divider mb-px">
            ...
            <AnimatedSection key={w.title} delay={i * 0.08}>
              ...
              >
                ...
                <div className="overflow-hidden">
                  <img src={w.image} alt={w.title} className="w-full aspect-[16/10] object-cover group-hover:scale-[1.03] group-hover:brightness-110 transition-all duration-500" loading="lazy" />
                </div>
                <div className="p-6 md:p-8">
                  <span className="font-mono text-[9px] tracking-[0.25em] uppercase text-muted-foreground block mb-2">{w.industry}</span>
                  <h3 className="font-display text-[26px] md:text-[30px] tracking-[0.03em] leading-none text-foreground mb-2">{w.title}</h3>
                  <p className="font-body text-[13px] leading-[1.72] text-muted-foreground line-clamp-2 mb-3">{w.brief[lang]}</p>
        ...
        {/* Grid — remaining 7 projects in 3-col grid */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-divider border border-divider border-t-0">
          {works.slice(2).map((w, i) => (
      ...
      {/* Unified Dialog — matches StartProjectDialog style */}
