        ...
        <div className="border-t border-divider">
          {jobs.map((job, i) => (
            <AnimatedSection key={job.title} delay={i * 0.05}>
              <div className="group border-b border-divider py-8 cursor-pointer hover:bg-secondary/50 transition-colors duration-300 px-4 -mx-4" onClick={() => setSelectedJob(job)}>
