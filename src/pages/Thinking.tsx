      ...
      <div className="max-w-[980px] mx-auto py-28 md:py-52">
        ...
        <div className="mt-8 md:mt-10">
          ...
          <div className="mt-10 border-t border-foreground/12 max-w-[640px]">
            {noise.map((s, i) => (
              <div key={s.k} className="grid grid-cols-[130px_1fr] md:grid-cols-[190px_1fr] gap-4 md:gap-8 py-6 md:py-7 border-b border-foreground/12 items-baseline">
      ...
      <div className="max-w-[980px] mx-auto py-28 md:py-52">
        ...
        <div className="mt-8 md:mt-10">
          ...
          <div className="mt-7 max-w-[640px] border-t border-foreground/12">
            {crossed.map((c, i) => (
              <div key={c} className="flex items-baseline gap-5 py-4 border-b border-foreground/12">
