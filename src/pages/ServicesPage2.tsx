...
const coreServices: ServiceDetail[] = [
  {
    ...
    outcome: [
      "Brand clarity improves 2–3x (teams align faster)",
      "Conversion improves 15–40%",
      "New customer segments identified (1–2 new segments)",
      "CAC reduced by 10–25%",
    ],
    ...
    timeline: "4–8 weeks",
    pricing: "Starting at 1,000,000 THB",
    typicalEngagement: "1,000,000 – 2,500,000 THB",
  ...
  },
  {
    ...
    outcome: [
      "Awareness increases 2–5x",
      "Engagement increases 50–200%",
      "Demand increases 15–35% (leads / bookings)",
    ],
    ...
    timeline: "3–6 weeks",
    pricing: "200,000 – 500,000 THB",
    typicalEngagement: "300,000 – 400,000 THB",
  },
  {
    num: "03",
    title: "Production",
    ...
    outcome: [
      "Watch time improves 30–80%",
      "Conversion improves 10–25%",
    ...
    timeline: "2–6 weeks",
    pricing: "100,000 – 300,000+ THB",
    typicalEngagement: "150,000 – 250,000 THB",
  ...
  },
  {
    ...
    outcome: [
      "Engagement increases 2–4x (vs digital only)",
      "Conversion increases 20–50%",
    ...
    timeline: "4–8 weeks",
    pricing: "150,000 – 500,000+ THB",
    typicalEngagement: "250,000 – 400,000 THB",
  },
  {
    num: "05",
    ...
    outcome: [
      "Conversion increases 20–60%",
      "Bounce rate decreases 15–30%",
      "Time on site increases 25–70%",
    ],
    ...
    timeline: "3–6 weeks",
    pricing: "80,000 – 250,000 THB",
    typicalEngagement: "120,000 – 200,000 THB",
  ...
  },
  {
    ...
    outcome: [
      "Organic reach increases 2–6x",
      "Search demand increases 20–80%",
      "Brand mentions increase 30–100%",
      "Conversion improves 10–25%",
    ],
    ...
    timeline: "1–3 months+",
    pricing: "80,000 – 150,000+ THB",
    typicalEngagement: "100,000 – 140,000 THB",
  },
];
...
const retainers: Retainer[] = [
  {
    ...
    star: true,
    desc: "We act as your ongoing creative partner.",
    outcome: ["Continuous campaign improvement", "1–3 new ideas per month", "Long-term growth consistency"],
    pricing: "100,000 – 150,000 THB / month",
  },
  {
    num: "08",
    title: "Content System",
    desc: "We maintain your content presence and extend campaigns.",
    outcome: ["Content output increases 3–5x", "Engagement increases 20–60%"],
    pricing: "60,000 – 120,000 THB / month",
  },
  {
    num: "09",
    title: "Channel Management",
    desc: "We ensure every channel contributes to growth, not just activity.",
    includes: ["Social", "SEO", "AEO"],
    outcome: ["Organic traffic increases 20–80%", "Cost per acquisition decreases 10–30%"],
    pricing: "40,000 – 80,000 THB / month",
  },
];
        ...
        {open && (
          ...
          >
            <div className="pb-12 pl-[calc(10px+1rem)] md:pl-[calc(10px+2rem)]">
                  ...
                  <ul className="space-y-2 mt-3">
                    {s.whatWeDo.map((w) => (
                      <li key={w} className="flex items-start gap-2">
                        ...
                        <span className="font-body text-[13px] text-foreground/70">{w}</span>
                      </li>
                    ))}
                  </ul>
                </div>
                  ...
                  <ul className="space-y-2 mt-3">
                    {s.outcome.map((o) => (
                      <li key={o} className="flex items-start gap-2">
                        <span className="text-accent-warm text-[8px] mt-1.5">◆</span>
                        <span className="font-body text-[13px] text-foreground/70">{o}</span>
                      </li>
                    ))}
                  </ul>
                </div>
              ...
              {/* Row 2: Pain points + Best for */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                <div>
                  <Label>Pain points</Label>
                  <ul className="space-y-1.5 mt-3">
                    {s.painPoints.map((p) => (
                      <li key={p} className="font-body text-[13px] text-muted-foreground">— {p}</li>
                    ))}
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="space-y-1.5 mt-3">
                    {s.bestFor.map((b) => (
                      <li key={b} className="font-body text-[13px] text-foreground/60">• {b}</li>
                    ))}
                  </ul>
                </div>
              </div>

              {/* Row 3: Without this + Who we work with */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                <div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mt-3">
                    {s.whoWeWorkWith.map((w) => (
                      <span key={w} className="font-mono text-[10px] tracking-[0.08em] text-muted-foreground border border-border px-3 py-1">
                        {w}
                      </span>
                    ))}
                  </div>
              ...
              <div className="border-t border-border/30 pt-6 flex flex-wrap gap-x-12 gap-y-4 items-start">
                ...
                <div>
                  <Label>Pricing</Label>
                  <p className="font-mono text-[13px] text-accent-warm mt-2">{s.pricing}</p>
                </div>
                <div>
                  <Label>Typical engagement</Label>
                  <p className="font-mono text-[13px] text-foreground/70 mt-2">{s.typicalEngagement}</p>
                </div>
              </div>
          ...
          >
            <div className="pb-10 pl-[calc(10px+1rem)] md:pl-[calc(10px+2rem)]">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                {r.includes && (
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2 mt-3">
                      {r.includes.map((inc) => (
                        <span key={inc} className="font-mono text-[10px] tracking-[0.08em] text-muted-foreground border border-border px-3 py-1">
                          {inc}
                        </span>
                      ))}
                    </div>
              ...
              <div className="mt-4 md:hidden">
                <Label>Pricing</Label>
                <p className="font-mono text-[13px] text-accent-warm mt-2">{r.pricing}</p>
              </div>
            </div>
          </motion.div>
        )}
    ...
    <main className="bg-background min-h-screen grain-overlay">
      ...
      <section className="min-h-[55vh] flex items-end px-4 sm:px-6 md:px-12 pb-12 md:pb-20 pt-24">
        <div className="max-w-5xl mx-auto w-full">
          ...
          >
            We don't offer everything.<br />
            We focus on what actually drives growth.
          </motion.p>
        </div>
      </section>
          ...
          <AnimatedSection>
            <div className="border border-accent-warm/20 p-8 md:p-12">
              ...
              <p className="font-body text-[15px] leading-[1.8] text-muted-foreground mb-6">
                If your brand has slowed down, start with:
              </p>
