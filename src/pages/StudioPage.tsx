...
const shows = [
  {
    num: "01", title: "NO SIGNAL", type: "Survival Documentary", status: "In Development", image: imgNoSignal,
    ...
    details: ["Follow real people who choose to disconnect from modern life and survive in raw nature.", "Each episode documents a different location — jungle, mountain, island — with zero preparation scripts.", "Shot in cinematic style with natural sound design. No narration, just pure experience.", "Platforms: YouTube, streaming partners."],
  },
  {
    num: "02", title: "LOOK YOUR BEST", type: "Beauty Documentary", status: "Concept", image: imgLookYourBest,
    ...
    details: ["Each episode follows one person preparing for a pivotal life moment through beauty and self-care.", "Explores the emotional connection between appearance and confidence.", "Features real makeup artists, stylists, and their clients' stories.", "Platforms: YouTube, Instagram, TikTok (short cuts)."],
  },
  {
    num: "03", title: "ØRIONS TALK", type: "Podcast", status: "In Production", image: imgOrionsTalk,
    ...
    details: ["Recorded at the ØRIONS office in Bangkok — intimate setting, natural conversation.", "Guests include creatives, founders, filmmakers, designers, and thinkers.", "Topics range from creative process, business philosophy, to cultural observations.", "Available as both video (YouTube) and audio (Spotify, Apple Podcasts)."],
  },
  {
    num: "04", title: "A LONG WAY", type: "Adventure Documentary", status: "Pre-production", image: imgALongWay,
    ...
    details: ["Each episode follows a different long-distance trail — from Thailand to international routes.", "Focus on the mental and physical transformation that happens on multi-day treks.", "Cinematic drone and handheld footage capturing the scale of nature.", "Platforms: YouTube, outdoor/adventure streaming partners."],
  },
  {
    num: "05", title: "IN BETWEEN DAY", type: "Lifestyle Documentary", status: "Concept", image: imgInBetweenDay,
    ...
    details: ["Each episode picks one person and captures 2–3 meaningful moments from their day.", "Observational style — minimal interviews, mostly watching and listening.", "Subjects range from artists and chefs to monks and street vendors.", "Platforms: YouTube, social media (short edits)."],
  },
  {
    num: "06", title: "365 DAYS", type: "Survival Documentary", status: "In Development", image: img365Days,
    ...
    details: ["A solo male protagonist simulates survival scenarios in a post-collapse world for 365 days.", "Each episode covers a different phase — shelter, food, defense, mental endurance.", "Filmed in remote and abandoned locations to create an authentic post-apocalyptic atmosphere.", "Blends documentary realism with cinematic storytelling. No scripts, real conditions.", "Platforms: YouTube, streaming partners."],
  },
];
...
const StudioPage = () => {
  ...
  return (
    <main className="bg-background min-h-screen grain-overlay">
      <SEO title="Studio — ØRIONS Original Productions" description="ØRIONS Studio produces original content — documentaries, podcasts, and shows that showcase our creative vision beyond client work." path="/studio" />
      <Navbar />
                  ...
                  <button onClick={() => toggle(i)} className="w-full text-left">
                    <div className="grid grid-cols-1 lg:grid-cols-2">
                      <div className="aspect-video relative overflow-hidden">
                        <img src={show.image} alt={show.title} className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-700" loading="lazy" />
                        ...
                        <div className="border-t border-border px-6 md:px-10 py-8 md:py-10">
                          ...
                          <ul className="space-y-4 max-w-2xl">
                            {show.details.map((detail, j) => (
                              <li key={j} className="flex gap-3"><span className="text-accent-warm/40 mt-1 shrink-0">—</span><span className="font-body text-[14px] leading-[1.7] text-muted-foreground">{detail}</span></li>
                            ))}
                          </ul>
                        </div>
                      </motion.div>
