        ...
        {doubled.map((it, i) => (
          <span key={i} className="flex items-center" aria-hidden={i >= items.length}>
            <span className="group/item inline-block px-10 md:px-14">
              <span className="font-display text-[13px] md:text-[15px] tracking-[0.14em] uppercase text-foreground/55 transition-colors duration-300 group-hover/item:text-orion">
                {it}
              </span>
            </span>
