  ...
  return (
    <div className="md:hidden fixed bottom-0 inset-x-0 z-40 bg-foreground text-background border-t border-background/15 grid grid-cols-2">
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="flex items-center justify-center gap-2 py-3.5 btn-label bg-foreground text-background border-l border-background/15 hover:bg-foreground hover:text-background hover:text-foreground transition-colors"
      >
