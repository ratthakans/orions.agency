...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "problem.desc": {
    ...
    th: "ทุกคนต่างเผยแพร่ ทุกคนต่างโฆษณา ทุกคนต่างพูดดังขึ้น แต่ความหมายกลับหายไป",
  },
  ...
  "impact.desc": {
    ...
    th: "ทุกบริการที่เรามอบถูกออกแบบเพื่อขับเคลื่อนตัวชี้วัดที่สำคัญ นี่คือผลลัพธ์เมื่อ ØRIONS ทำงานร่วมกับแบรนด์",
  },

  // Process
  "process.desc": {
    en: "A proven four-step process that takes brands from unclear to unforgettable.",
    th: "กระบวนการ 4 ขั้นตอนที่พิสูจน์แล้ว พาแบรนด์จากความไม่ชัดเจนสู่ความน่าจดจำ",
  },
  "process.step1": {
    en: "We immerse ourselves in your brand, market, and audience to understand the full landscape before making any decisions.",
    th: "เราศึกษาแบรนด์ ตลาด และกลุ่มเป้าหมายอย่างลึกซึ้ง ก่อนตัดสินใจใดๆ",
  },
  "process.step2": {
  ...
  "process.step3": {
    ...
    th: "ทีมของเราสร้างสรรค์ผลงาน แคมเปญ และระบบที่ออกแบบมาเพื่อตัดผ่านเสียงรบกวนและสร้างผลกระทบจริง",
  },
  "process.step4": {
    en: "We deploy, measure, and optimize — ensuring your communication compounds over time and delivers lasting ROI.",
    th: "เราเปิดตัว วัดผล และปรับปรุง — เพื่อให้การสื่อสารของคุณเติบโตขึ้นเรื่อยๆ และให้ผลตอบแทนที่ยั่งยืน",
  },
  ...
  "contact.desc": {
    ...
    th: "เล่าให้เราฟังเกี่ยวกับแบรนด์และสิ่งที่คุณต้องการสร้าง เราจะตอบกลับภายใน 24 ชั่วโมง",
  },
  "contact.thankyou": {
  ...
  "services.desc": {
    ...
    th: "บริการเหล่านี้มุ่งเน้นที่การกำหนดทิศทางและสร้างสินทรัพย์การสื่อสารหลักของแบรนด์",
  },

  // Programs
  "programs.desc": {
    en: "These programs help brands maintain consistent communication and long-term digital presence.",
    th: "โปรแกรมเหล่านี้ช่วยให้แบรนด์รักษาการสื่อสารที่สม่ำเสมอและสร้างตัวตนดิจิทัลระยะยาว",
  },
  ...
  "careers.desc": {
    ...
    th: "เรามองหาคนที่มีความสามารถและใฝ่รู้ ที่อยากสร้างสรรค์ผลงานอย่างมีความหมาย ถ้าคุณคือคนนั้น เรายินดีรับฟัง",
  },
  "careers.norole": {
    en: "Don't see your role? We're always open to meeting great people.",
    th: "ไม่เห็นตำแหน่งที่ใช่? เราเปิดรับคนเก่งๆ เสมอ",
  },
  ...
  "about.desc": {
    ...
    th: "ครีเอทีฟเอเจนซี่ที่ขับเคลื่อนด้วยความหมาย เราช่วยแบรนด์กำหนดทิศทางและสื่อสารผ่านแคมเปญ คอนเทนต์ และประสบการณ์ดิจิทัล",
  },
  "about.team_desc": {
