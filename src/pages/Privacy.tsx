...
const sections = [
  {
    n: "01",
    h: "ข้อมูลที่เราเก็บ",
    body: "เฉพาะที่คุณกรอกเอง — ชื่อ ชื่อแบรนด์ อีเมล และข้อความ จากฟอร์มติดต่อ · สถิติการใช้งานเว็บเก็บแบบไม่ระบุตัวตนผ่าน Plausible (ไม่มีคุกกี้ ไม่ติดตามข้ามเว็บ).",
  },
  {
    n: "02",
    h: "ใช้ทำอะไร",
