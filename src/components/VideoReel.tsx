                ...
                {isPlaying ? (
                  ...
                  >
                    {poster ? (
                      ...
                      <div className="w-full h-full bg-background/10" />
                    )}
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="w-16 h-16 md:w-20 md:h-20 rounded-full border border-foreground/80 bg-background/10 flex items-center justify-center text-foreground mix-blend-difference transition-transform duration-500 group-hover:scale-110">
                        <Play className="w-6 h-6 md:w-7 md:h-7 ml-1" fill="currentColor" />
                      </div>
                    </div>

                    <div className="absolute bottom-0 left-0 right-0 p-4 md:p-6 flex items-end justify-between text-foreground mix-blend-difference">
